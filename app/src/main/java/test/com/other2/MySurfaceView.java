...
public class MySurfaceView extends GLSurfaceView {
    ...
    private void rotate() {
        mRenderer.yAngle += 10*TOUCH_SCALE_FACTOR;//设置沿x轴旋转角度
//        mRenderer.xAngle += 4;//设置沿z轴旋转角度
...
//                mRenderer.zAngle += (dy + dx) / 2 * TOUCH_SCALE_FACTOR;//设置沿z轴旋转角度
//                requestRender();//重绘画面
//        }
...
//            MatrixState.translate(0, 16, 60);   //ch.obj
            //绕Y轴、Z轴旋转
...
//            float ratio = (float) height / width;
            //调用此方法计算产生透视投影矩阵
            MatrixState.setProjectFrustum(-ratio, ratio, -ratio, ratio, 0.1f, 2000);
            //调用此方法产生摄像机9参数位置矩阵
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            lovo = LoadUtil.loadFromFile("asm0001.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
//            lovo=LoadUtil.loadFromFile("ch_t.obj", MySurfaceView.this.getResources(),MySurfaceView.this);
            //加载纹理
            textureId = initTexture(R.mipmap.ghxp);
        }
    }
